...
namespace GUI
{
    public partial class DanhSachGiaoVien : Form
    {
        ...
        GiaoVienBUS hvbus = new GiaoVienBUS();
        ...
        public DanhSachGiaoVien(string mand, string hoten, string diachi, string sdt, string taikhoan, string matkhau, string quyen, string ngaysinh, string vitrivieclam, string email)
        {
            InitializeComponent();
            this.MaND = mand;
            this.HoTen = hoten;
            ...
            dgvgv.DataSource = hvbus.DatagvFind(sql);
        }
        ...
        private void btnxuat_Click(object sender, EventArgs e)
        {
            ...
            {
                ToExcel(dgvgv, saveDialog.FileName);
            }
        }
    }
}
