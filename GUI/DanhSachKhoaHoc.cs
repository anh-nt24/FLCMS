...
namespace GUI
{
    public partial class DanhSachKhoaHoc : Form
    {
        ...
        KhoaHocBUS hvbus = new KhoaHocBUS();
        ...
        public DanhSachKhoaHoc(string mand, string hoten, string diachi, string sdt, string taikhoan, string matkhau, string quyen, string ngaysinh, string vitrivieclam, string email)
        {
            InitializeComponent();
            this.MaND = mand;
            this.HoTen = hoten;
            ...
            dgvkh.DataSource = hvbus.DatagvFind(sql);
        }
        ...
        private void btnxuat_Click(object sender, EventArgs e)
        {
            ...
            {
                ToExcel(dgvkh, saveDialog.FileName);
            }
        }
    }
}
